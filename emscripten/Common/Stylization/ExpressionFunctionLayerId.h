...
{
public:
    ExpressionFunctionLayerId(const wchar_t* layerId);
    ~ExpressionFunctionLayerId();

    static ExpressionFunctionLayerId* Create(const wchar_t* layerId);
